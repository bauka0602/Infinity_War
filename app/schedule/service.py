...
from ..core.db import db_execute, db_executemany, query_all
from ..programmes.education import get_home_room_programmes
from ..core.errors import ApiError
from ..teachers.preferences import get_approved_teacher_preferences
from ..programmes.utils import normalize_programme_text
from ..rooms.availability import get_room_blocked_slots, recompute_room_availability
from .time_slots import SCHEDULE_HOURS
from .config import CP_SAT_SOLVE_SECONDS, normalize_schedule_algorithm
