...
class Course(Base):
    ...
    programme: Mapped[str | None] = mapped_column(Text)
    programme_kk: Mapped[str | None] = mapped_column(Text)
    programme_en: Mapped[str | None] = mapped_column(Text)
    ...
    cycle_kk: Mapped[str | None] = mapped_column(Text)
    cycle_en: Mapped[str | None] = mapped_column(Text)
    component: Mapped[str | None] = mapped_column(Text)
    component_kk: Mapped[str | None] = mapped_column(Text)
    component_en: Mapped[str | None] = mapped_column(Text)
    department_kk: Mapped[str | None] = mapped_column(Text)
    department_en: Mapped[str | None] = mapped_column(Text)
...
class CourseComponent(Base):
    ...
    course_name_kk: Mapped[str | None] = mapped_column(Text)
    course_name_en: Mapped[str | None] = mapped_column(Text)
    programme: Mapped[str | None] = mapped_column(Text)
